...
public class androidService extends Service {
    ...
    private void doListen() {
        ...
        try {
            ...
            while (mainThreadFlag) {
                System.out.println("ccccccccccccccccccc   "+serverSocket.getInetAddress().getHostAddress()+ "  "+Thread.currentThread().getName() + "---->"
                        + " doListen() listen");

                Socket client = serverSocket.accept();
                System.out.println("ccccccccccccccccccc   client   "+client.toString());
    ...
    public void onStart(Intent intent, int startId) {
        System.out.println("ccccccccccccccccccc   "+Thread.currentThread().getName() + "---->" + " onStart()");
    ...
    public IBinder onBind(Intent arg0) {
        System.out.println("ccccccccccccccccccc   "+"  onBind");
        return null;
    }
}
