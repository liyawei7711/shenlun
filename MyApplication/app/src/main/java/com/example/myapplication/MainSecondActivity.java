...
public class MainSecondActivity extends AppCompatActivity implements SwanTextView.OnTextChangedListener {
    ...
    private void checkPermission() {
        ...
        for (int i = 0; i < PERMISSIONS_STORAGE.length; i++) {
            if (PackageManager.PERMISSION_GRANTED !=
                    ContextCompat.checkSelfPermission(MainSecondActivity.this, PERMISSIONS_STORAGE[i])) {
                needReq = true;
            }
        }
        if (needReq) {
