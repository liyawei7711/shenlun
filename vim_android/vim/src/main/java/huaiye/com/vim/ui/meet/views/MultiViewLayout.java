...
public class MultiViewLayout extends ViewGroup {
    ...
    public static final int ONE_PAGE_NUM = 4;
...
//    private float mLastX;
    ...
    public void setOnPageListener(MultiViewLayout.onPageListener onPageListener) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                invalidate();
                int targetPage = (haveScrollY + scrollSize) / getHeight();
                if (targetPage != mLastPage) {
                    mLastPage = targetPage;
                    if (onPageListener != null) {
                        onPageListener.onPageChange(targetPage);
                    }
                }
                break;
        }
