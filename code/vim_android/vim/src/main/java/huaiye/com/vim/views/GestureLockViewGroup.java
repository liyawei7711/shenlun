...
public class GestureLockViewGroup extends RelativeLayout {
     ...
     */
    private int mNoFingerInnerCircleColor = Color.TRANSPARENT;//0xFF55a2fd;
    /**
     * GestureLockView无手指触摸的状态下外圆的颜色
     */
    private int mNoFingerOuterCircleColor = 0xFF55a2fd;//0xFF378FC9; //0xFF484956;
    /**
     * GestureLockView手指触摸的状态下内圆和外圆的颜色
     */
    private int mFingerOnColor = 0xFF55a2fd;
    /**
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mGestureLockViews == null) {
            ...
            mGestureLockViewWidth = (int) (3 * mWidth * 1.0f / (5 * mCount + 1));
            //计算每个GestureLockView的间距
            mMarginBetweenLockView = (int) (mGestureLockViewWidth * 0.55);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mOnGestureLockViewListener != null && mChoose.size() > 0) {
                    ...
                    mOnGestureLockViewListener.onGestureChoose(mChoose);
                    if (this.mTryTimes == 0) {
    ...
    public interface OnGestureLockViewListener {
        ...
        void onGestureChoose(List<Integer> mChoose);
    }
}