...
public class ContactsItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContactsItemAdapter(Context context, ArrayList<User> list, char letter, boolean isChoice,
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        Glide.with(mContext)
                .load(AppDatas.Constants().getAddressWithoutPort() + mDataList.get(position).strHeadUrl)
