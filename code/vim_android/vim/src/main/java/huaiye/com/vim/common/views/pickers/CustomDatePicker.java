...
public class CustomDatePicker {
    ...
    private final String Temp1 = "yyyy-MM-dd";
    private SimpleDateFormat sdf1 = new SimpleDateFormat(Temp1, Locale.CHINA);
    ...
    public CustomDatePicker(int type, Context context, ResultHandler resultHandler, long startDate, long endDate) {
        this.type = type;
    ...
    public CustomDatePicker(int type, Context context, ResultHandler resultHandler, Date startDate, Date endDate) {
        this.type = type;
        initParams(context, resultHandler, sdf.format(startDate), sdf.format(endDate));
    }
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (type == 1) {
                        SimpleDateFormat formatter = new SimpleDateFormat(Temp1);
                        Date date;
                        String str = sdf1.format(selectedCalender.getTime());
                        date = formatter.parse(str);
                        handler.handle(str, date.getTime());
                    } else {
